 ...
 gn gen --ide=vs2019 --args='target_os=\"win\" target_cpu=\"x64\" is_debug=false is_clang=true proprietary_codecs=true use_lld=false use_custom_libcxx=false symbol_level=0 is_component_build=false rtc_use_h264=true ffmpeg_branding=\"Chrome\" rtc_build_ssl=true'  out/test_vs2019_realse
